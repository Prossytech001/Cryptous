...
//       console.log("✅ Signup success:", res.data);
//       login(res.data); // Log in the user if needed

//       // Redirect to OTP verification page after successful signup
//       navigate("/dashboard"); // instead of login or verify-otp
// localStorage.setItem("email", email); // (optional) save email for verification tracking // Adjust the route to where you want the user to go
