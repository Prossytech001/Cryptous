...
import { upgradeData } from '../../../api/data' // Adjust path if alias is unsupported
        ...
        <div className='grid lg:grid-cols-2 sm:gap-0 gap-10 items-center'>
          <div>
            ...
            <p className='text-muted/60 text-18 mb-7'>
              Enhance performance, security, and value with CryptoFlux next-gen financial infrastructure.
            </p>
