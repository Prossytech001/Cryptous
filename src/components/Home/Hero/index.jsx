          ...
          <motion.div {...leftAnimation} className=' flex flex-col justify-center   lg:col-span-5 col-span-12'>
            ...
            <h1 className='font-medium  md:text-70 text-54 lg:text-start  text-white mb-10'>
             Grow Your   <span className='text-primary'>Wealth</span>  with{' '}
              <span className='text-primary'>CryptoFlux</span>!
            </h1>
            ...
            {/* <div className='flex items-center md:justify-start justify-center gap-12 mt-20'>
              <a href='#' className='hover:scale-110 duration-300'>
                <img src={playStore} alt='Play Store' width={240} height={70} />
              </a>
              <a href='#' className='hover:scale-110 duration-300'>
                <img src={appleStore} alt='App Store' width={240} height={70} />
              </a>
            </div> */}
          </motion.div>
          <motion.div {...rightAnimation} className='col-span-7 lg:block hidden'>
            <div className='ml-20 -mr-64'>
              <img src={bannerImage} alt='Banner' width={1150} height={1150} />
            </div>
          </motion.div>
        </div>
        <CardSlider />
