  ...
  return (
    ...
    <div className="container_about ">
      ...
      <section className="mission-content mb-12">
        ...
        <p className="text-lg leading-relaxed">
          To <span className="font-semibold text-white">simplify crypto investments</span> by providing reliable, transparent, and rewarding opportunities that help users achieve financial independence.
        </p>
      </section>
      ...
      <section className="whychoose-content mb-12">
        ...
        <ul className="space-y-4 text-lg list-disc list-inside">
          <li>
            <span className="font-medium text-yellow-400">Daily ROI:</span> Earn daily returns on your investments, automatically or manually, depending on your plan.
          </li>
          <li>
            <span className="font-medium text-yellow-400">Flexible Plans:</span> Choose from a variety of investment plans that suit your budget and goals.
          </li>
          <li>
            <span className="font-medium text-yellow-400">Secure Platform:</span> We use the latest security protocols to ensure your data and funds are safe.
          </li>
          <li>
            <span className="font-medium text-yellow-400">User-First Design:</span> A clean dashboard, detailed insights, and full control over your funds.
          </li>
          <li>
            <span className="font-medium text-yellow-400">No Hidden Fees:</span> What you invest is what you grow — no tricks, no gimmicks.
          </li>
        </ul>
        </div>
      </section>
